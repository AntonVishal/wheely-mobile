...
export default function OnboardingScreen(){
    ...
    return(
        <View style={{width:screenWidth, ...styles.main_container}}>
            <Animated.View style={[styles.logo_screen, animatedLogoScreenHeight]}>
                <Animated.Image source={require("../../../assets/images/icon.png")} style={[styles.logo, animatedLogo]}/>
                <Text style={styles.logo_one_line}>Something for Disabled</Text>
            </Animated.View>
            <Animated.View style={[styles.content_container,animatedOptionsScreenHeight]}>
                <Stack screenOptions={{
